	...
	function storefront_product_categories( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			$args = apply_filters( 'storefront_product_categories_args', array(
				...
				'child_categories' 	=> 0,
				'orderby' 			=> 'name',
				'title'				=> __( 'Shop by Categoryz', 'storefront' ),
			) );
...
//Turn this off with this variable
$nah = false;
		if ( storefront_is_woocommerce_activated() && $nah) {
	...
	function storefront_popular_products( $args ) {
		...
		if ( storefront_is_woocommerce_activated() ) {
			...
			$args = apply_filters( 'storefront_popular_products_args', array(
				'limit'   => 4,
				'columns' => 4,
				'title'   => __( 'Fan Favorites7', 'storefront' ),
			) );

			echo "HERE"?;

			echo '<section class="storefront-product-section storefront-popular-products" aria-label="Popular Products987">';
